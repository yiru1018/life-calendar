...
function StartCalendar({ showStartCalendar, setShowStartCalendar }) {
  ...
  const { monthIndex, setSmallCalendarMonth, eventStartDay, setEventStartDay } =
  ...
  const getClassName = (day) => {
    ...
    const slcDay = eventStartDay.format(format);
